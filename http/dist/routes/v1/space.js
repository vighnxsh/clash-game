...
exports.spaceRouter.post("/", user_1.userMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const map = yield client.map.findFirst({
        where: {
    ...
    console.log(map.mapElements.length);
    let space = yield client.$transaction(() => __awaiter(void 0, void 0, void 0, function* () {
        const space = yield client.space.create({
            data: {
                name: parsedData.data.name,
                width: map.width,
...
exports.spaceRouter.post("/element", user_1.userMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (req.body.x < 0 || req.body.y < 0 || req.body.x > (space === null || space === void 0 ? void 0 : space.width) || req.body.y > (space === null || space === void 0 ? void 0 : space.height)) {
