    ...
    <div className="p-4" onKeyDown={handleKeyDown} tabIndex={0}>
        ...
        <div className="mb-4 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-blue-50 p-3 rounded-lg">
            <p className="text-sm font-medium text-blue-800">Connected Users</p>
            <p className="text-lg font-bold text-blue-900">{users.size + (currentUser ? 1 : 0)}</p>
          </div>
          <div className="bg-green-50 p-3 rounded-lg">
            <p className="text-sm font-medium text-green-800">Your Position</p>
            <p className="text-sm text-green-700">{currentUser ? `X: ${currentUser.x}, Y: ${currentUser.y}` : 'Not connected'}</p>
          </div>
          <div className="bg-purple-50 p-3 rounded-lg">
            <p className="text-sm font-medium text-purple-800">Room ID</p>
            <p className="text-xs text-purple-700 font-mono">{spaceId}</p>
          </div>
        </div>
